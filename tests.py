...
class TestGetFileInfo(unittest.TestCase):
    ...
    def test_run_python_main_no_args(self):
    ...
    def test_run_python_calculator_tests(self):
        result = run_python_file("calculator", "tests.py")
        print(result)
    
    def test_run_python_calculator_main_error(self):
        result = run_python_file("calculator", "../main.py")
        print(result)

    def test_run_python_calculator_nonexistent(self):
        result = run_python_file("calculator", "nonexistent.py")
        print(result)

    def test_run_python_calculator_not_python(self):
        result = run_python_file("calculator", "notpython")
        print(result)
